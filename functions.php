...
function register_theme_menus() {
	...
	register_nav_menus(
		array(
			'primary-menu' => __( 'Primary Menu', 'treehouse-theme' )
		)
	);
...
function wpa199335_page_sidebar(){
    register_sidebar(array(
        'name' => __( 'Page Sidebar', 'treehouse-theme'),
        'id' => 'page',
        'description' => __( 'Displays on the side of pages with a sidebar','treehouse-theme' ),
        'before_widget' => '<div class="widget">',
        'after_widget' => '</div>',
        'before_title' => '<h2 class="module-heading">',
        'after_title' => '</h2>'
